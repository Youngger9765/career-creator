...
class ConnectionManager:
    ...
    async def connect(
        self, websocket: WebSocket, room_id: str, user_info: Dict[str, Any]
    ):
...
async def handle_websocket_message(
    message: Dict[str, Any], websocket: WebSocket, room_id: str, session: Session
):
...
async def handle_card_event_message(
    data: Dict[str, Any], websocket: WebSocket, room_id: str, session: Session
):
    """Handle card event and broadcast to room"""
...
async def handle_chat_message(data: Dict[str, Any], websocket: WebSocket, room_id: str):
    """Handle chat message"""
...
async def handle_user_action_message(
    data: Dict[str, Any], websocket: WebSocket, room_id: str
):
