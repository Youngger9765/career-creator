    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-700 text-center mb-4">Quick Demo Login</h2>
          ...
          {demoAccounts.map((account) => (
            ...
            >
              ...
              <div className="text-xs text-blue-600 mt-1">Role: {account.roles.join(', ')}</div>
            </button>
          ))}

          {isLoading && <div className="text-center text-gray-600">Logging in...</div>}
        </div>
